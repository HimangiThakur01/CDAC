...
Question NO.2 Days of the Week 
...
public class Calculator {
  public static void main(String[] args) {
    ...
    double result = 0;
    boolean validOperation = true; // To check for valid operations
...
public class DiscountCalculator {
  public static void main(String[] args) {
    ...
    // Apply additional discount for membership
...
public class StudentResult {
  public static void main(String[] args) {
    ...
    if (sub1 < 40) failCount++;
    if (sub2 < 40) failCount++;
    if (sub3 < 40) failCount++;

    // Nested switch to determine pass or fail status
    switch (failCount) {
      case 0:
        System.out.println("Congratulations! You have passed.");
        break;
      case 1:
        System.out.println("You have failed in 1 subject.");
        break;
      case 2:
        System.out.println("You have failed in 2 subjects.");
        break;
      case 3:
        System.out.println("You have failed in all subjects.");
        break;
      default:
